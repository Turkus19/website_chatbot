...
(function() {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            <h2 class="registration-title">Podaj swoje dane, aby rozpocząć rozmowę</h2>
            <form class="registration-form">
                <div class="form-field">
                    <label class="form-label" for="chat-user-name">Imię</label>
                    <input type="text" id="chat-user-name" class="form-input" placeholder="Twoje imię" required>
                    <div class="error-text" id="name-error"></div>
                </div>
                <div class="form-field">
                    <label class="form-label" for="chat-user-email">E-mail</label>
                    <input type="email" id="chat-user-email" class="form-input" placeholder="Twój adres e-mail" required>
                    <div class="error-text" id="email-error"></div>
                </div>
                <button type="submit" class="submit-registration">Przejdź do czatu</button>
            </form>
        </div>
    `;
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Napisz swoją wiadomość..." rows="1"></textarea>
    ...
    launchButton.innerHTML = `
        ...
        <span class="chat-launcher-text">Potrzebujesz pomocy?</span>`;
    ...
    async function handleRegistration(event) {
        ...
        if (!email) {
            emailError.textContent = 'Proszę podać swój e-mail';
        ...
        try {
            ...
            const userInfoMessage = `Imię: ${name}\nE-mail: ${email}`;
            ...
            errorMessage.textContent = "Przepraszamy, nie udało się połączyć z serwerem. Proszę spróbować ponownie później.";
    ...
    async function submitMessage(messageText) {
        ...
        try {
            ...
            const errorMessage = document.createElement('div');
            errorMessage.className = 'chat-bubble bot-bubble';
            errorMessage.textContent = "Przepraszamy, nie udało się wysłać Twojej wiadomości. Proszę spróbować ponownie.";
            messagesContainer.appendChild(errorMessage);
            messagesContainer.scrollTop = messagesContainer.scrollHeight;
        } finally {
